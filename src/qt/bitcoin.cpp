...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Silkcoin");
    QApplication::setOrganizationDomain("silkcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Silkcoin-Qt-testnet");
    else
        QApplication::setApplicationName("Silkcoin-Qt");
